        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8 lg:py-24">
          <div className="max-w-3xl">
            <p className="mb-3 font-semibold uppercase tracking-wider text-[#14b8a6]">
              Hertfordshire Drainage Specialists
            </p>

            <h1 className="text-4xl font-bold leading-tight sm:text-5xl">
              Drainage Services Across Hertfordshire
            </h1>

            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200">
              UK Drain Response provides professional drainage services for
              homes and businesses across Hertfordshire, including drain
              unblocking, CCTV surveys, drain jetting, repairs and emergency
              drainage.
            </p>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
                Professional Drainage Help in Hertfordshire
              </h2>

              <p className="mt-6 text-lg leading-8 text-slate-600">
                Drainage problems can range from a straightforward blockage to
                damaged underground pipework. UK Drain Response can help
                identify the problem and provide the appropriate drainage
                service.
              </p>

              <p className="mt-4 text-lg leading-8 text-slate-600">
                We provide drainage services throughout Hertfordshire for
                domestic properties, landlords, businesses and commercial
                premises.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-slate-100 p-8">
              ...
              <ul className="mt-6 space-y-4 text-slate-700">
                ...
                <li className="flex gap-3">
                  <span className="font-bold text-[#14b8a6]">✓</span>
                  Damaged or cracked drainage pipes
                </li>
      ...
      <section className="bg-slate-50">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <p className="font-semibold text-[#0f766e]">
              Hertfordshire Drainage Services
            </p>

            <h2 className="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
              The Right Service for Your Drainage Problem
            </h2>

            <p className="mt-4 text-lg text-slate-600">
              Different drainage problems require different solutions. Explore
              our main drainage services below.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-4 leading-7 text-slate-600">
                Help with blocked toilets, gullies and underground drainage
                systems.
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-7 text-slate-600">
                Inspect underground drainage and identify hidden faults or
                damage.
              </p>
              <p className="mt-5 font-semibold text-[#0f766e]">
                CCTV Surveys →
            ...
            >
              ...
              <p className="mt-4 leading-7 text-slate-600">
                Repair options for cracked, damaged or collapsed drainage
                systems.
              </p>
              <p className="mt-5 font-semibold text-[#0f766e]">
                Drain Repairs →
            ...
            >
              ...
              <p className="mt-4 leading-7 text-slate-600">
                Trenchless repair options for suitable damaged drainage
                pipework.
              </p>
              <p className="mt-5 font-semibold text-[#0f766e]">
                Drain Relining →
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-slate-600">
                UK Drain Response provides drainage services across
            ...
            <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
              <div>
                <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">
                  Is Your Drainage Problem Urgent?
                </h2>
      ...
      <section className="bg-[#082f49]">
        <div className="mx-auto max-w-7xl px-6 py-16 text-center lg:px-8">
          <h2 className="text-3xl font-bold text-white sm:text-4xl">
            Need a Drainage Engineer in Hertfordshire?
          </h2>
